        ...
        <div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
          <div class="hero-text">
            <div class="hero-text-tablecell">
              ...
              <h1> ارقى واجود المنتجات</h1>
              <div class="hero-btns">
                <a href="shop.html" class="boxed-btn">منتجات اكثر شهره </a>
                <a href="contact.html" class="bordered-btn"> خصومات هائلة</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-10 offset-lg-1 text-center">
          <div class="hero-text">
            <div class="hero-text-tablecell">
              ...
              <h1> منتجات ماركه  % 💯 </h1>
              <div class="hero-btns">
                <a href="shop.html" class="boxed-btn">قم بزيارة المتجر</a>
        ...
        <div class="col-lg-10 offset-lg-1 text-right">
          <div class="hero-text">
            <div class="hero-text-tablecell">
              ...
              <h1>احصل على خصومات</h1>
              <div class="hero-btns">
                <a href="shop.html" class="boxed-btn">زياره المتجر</a>
                <a href="contact.html" class="bordered-btn">اتصل بنا</a>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="list-box d-flex justify-content-start align-items-center">
          ...
          <div class="content">
            <h3>إعادة</h3>
            <p>
              احصل على استرداد في غضون 3 أيام!
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-8 offset-lg-2 text-center">
        <div class="section-title">
          <h3><span class="orange-text">منتجا</span>تنا</h3>
          <p>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 text-center">
        <div class="single-product-item">
          ...
          <a href="cart.html" class="cart-btn"><i class="fas
            fa-shopping-cart"></i> إضافة للسلة</a>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="single-latest-news">
          <a href="single-news.html"><div class="latest-news-bg news-bg-1"></div>
          </a>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-latest-news">
          <a href="single-news.html"><div class="latest-news-bg news-bg-2"></div>
          </a>
          <div class="news-text-box">
      ...
      <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
        <div class="single-latest-news">
          <a href="single-news.html"><div class="latest-news-bg news-bg-3"></div>
          </a>
          <div class="news-text-box">
