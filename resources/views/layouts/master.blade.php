            ...
            <div class="announcement-inner">
                <div class="announcement-slides" id="announcementSlides">
                    <div class="announcement-slide active">
                        ...
                        <span class="announcement-text">خصم <strong>30%</strong> على جميع الإلكترونيات - لفترة
                            محدودة</span>
                    </div>
            ...
            <div class="container">
                ...
                <div class="search-wrapper" id="searchWrapper">
                    <div class="search-bar">
                        <input type="search" class="search-input" placeholder="ابحث عن المنتجات، الماركات..."
                    ...
                    <div class="search-suggestions" id="searchSuggestions">
                        ...
                        <div class="suggestion-item">
                            <i data-lucide="search" class="suggestion-icon"></i> <span>هاتف <span
                                    class="suggestion-highlight">آيفون 15</span> برو</span>
                        </div>
                        <div class="suggestion-item">
                            <i data-lucide="search" class="suggestion-icon"></i> <span>ساعة <span
                                    class="suggestion-highlight">آبل</span> الترا</span>
                        </div>
                        <div class="suggestion-item">
                            <i data-lucide="search" class="suggestion-icon"></i> <span>سماعات <span
                                    class="suggestion-highlight">لاسلكية</span> مع عزل ضوضاء</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="user-actions">
                    <!-- زر البحث للجوال -->
                    <button class="mobile-search-toggle action-btn" id="mobileSearchToggle"><i
                    ...
                    <li class="nav-item" id="megaMenuItem">
                        ...
                        <div class="mega-menu">
                            ...
                            <div class="mega-featured">
                                <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' fill='%23F1F5F9' rx='8'/%3E%3Ctext x='60' y='60' text-anchor='middle' dominant-baseline='middle' font-size='36'%3E📱%3C/text%3E%3C/svg%3E"
                                    alt="عرض">
    ...
    <div class="mobile-drawer" id="mobileDrawer">
        ...
        <div class="search-bar" style="margin-bottom:1.2rem; border:1px solid var(--border);">
            <input type="search" placeholder="ابحث..."
                style="flex:1; padding:0.6rem; border:none; background:transparent; outline:none;">
            <button style="padding:0.6rem; color:var(--accent);"><i data-lucide="search"></i></button>
        </div>
        <div style="display:flex; flex-direction:column; gap:0.5rem;">
            <a href="#" style="padding:0.75rem; border-bottom:1px solid var(--border); font-weight:500;">📱
                إلكترونيات</a>
        ...
        <a href="#" style="display:flex; align-items:center; gap:0.5rem; padding:0.5rem;"><i
                data-lucide="user"></i> حسابي</a>
        <a href="#" style="display:flex; align-items:center; gap:0.5rem; padding:0.5rem;"><i
                data-lucide="heart"></i> المفضلة (3)</a>
        <a href="#" style="display:flex; align-items:center; gap:0.5rem; padding:0.5rem;"><i
                data-lucide="shopping-cart">{{ $cartCount }}</i> السلة (2) - 1,250 ر.س</a>
    </div>
    @yield('content')
